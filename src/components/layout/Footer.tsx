      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Heart size={16} className="text-neon-pink fill-neon-pink animate-pulse" />
            <p className="text-white/60 text-sm">
              and Joyfull!
            </p>
          </div>
          ...
          <button 
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 p-3 bg-neon-blue/10 hover:bg-neon-blue/20 border border-neon-blue/30 rounded-full transition-all duration-300 hover:shadow-[0_0_15px_rgba(0,240,255,0.5)] group"
